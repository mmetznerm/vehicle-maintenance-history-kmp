...
import com.mmetzner.vehiclemaintenance.core.sync.WorkManagerOutboxSyncRequestScheduler
...
actual val platformModule: Module = module {
    ...
    single<OutboxSyncRequestScheduler> { WorkManagerOutboxSyncRequestScheduler(androidContext()) }
}
